...
$update = [ordered]@{
    ...
    mandatory = $false
    notes = @(
        $utf8.GetString([Convert]::FromBase64String("0J/QvtC0INC60L3QvtC/0LrQvtC5INC30LDQv9GD0YHQutCwINC/0L7QutCw0LfQsNC9IElQINGB0LXRgNCy0LXRgNCwOiAyMTMuMTUyLjQzLjQ0OjI1Njk3Lg==")),
        $utf8.GetString([Convert]::FromBase64String("0J/QtdGA0LXQtCDQt9Cw0L/Rg9GB0LrQvtC8IE1pbmVjcmFmdCDRgdC10YDQstC10YAgbWluaXZpYmUg0LDQstGC0L7QvNCw0YLQuNGH0LXRgdC60Lgg0LTQvtCx0LDQstC70Y/QtdGC0YHRjyDQsiBzZXJ2ZXJzLmRhdC4=")),
        $utf8.GetString([Convert]::FromBase64String("0JDQstGC0L7QvtCx0L3QvtCy0LvQtdC90LjQtSDRgtC10L/QtdGA0Ywg0L/QvtC60LDQt9GL0LLQsNC10YIg0L3QvtCy0YPRjiDQstC10YDRgdC40Y4g0Lgg0L/QtdGA0LXQt9Cw0L/Rg9GB0LrQsNC10YIg0LvQsNGD0L3Rh9C10YAg0YLQvtC70YzQutC+INC/0L7RgdC70LUgT0su"))
    )
}
